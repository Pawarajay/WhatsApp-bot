...
//       parameters: {
//         type: "object",
//         properties: { productId: { type: "number", description: "WooCommerce product ID" } },
//         required: ["productId"],
//       },
//     },
//   },
...
//       name: "update_cart",
//       description:
//         "Replace the customer's current cart with the given list of items (productId, quantity). Always look up prices via get_products/get_product_details first — never invent a price here. Call this whenever the cart changes. Returns the updated cart and total computed from live prices.",
//       parameters: {
//         type: "object",
//         properties: {
//           items: {
...
//           paymentPreference: { type: "string", description: "e.g. 'Cash on Delivery' or 'Online/UPI'" },
//           notes: { type: "string" },
//         },
